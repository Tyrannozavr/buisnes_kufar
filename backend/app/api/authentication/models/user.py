...
class User(Base):
    ...
    # Дублировать уведомления о новых сообщениях на email регистрации
    email_notifications_enabled = Column(Boolean, nullable=False, default=False, server_default="false")
