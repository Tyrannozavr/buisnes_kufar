...
class AnnouncementService:
    ...
    async def create_announcement(self, user: User, announcement_data: AnnouncementCreate,
                                  notifications: dict) -> AnnouncementResponse:
    ...
    async def get_company_announcements(self, user: User, page: int = 1,
                                        per_page: int = 10) -> AnnouncementListResponse:
    ...
    async def update_announcement(self, user: User, announcement_id: int,
                                  announcement_data: AnnouncementUpdate) -> AnnouncementResponse:
        """Обновить объявление"""
        ...
        updated_announcement = await self.announcement_repository.update(announcement_id,
                                                                         AnnouncementUpdate(**update_data))
    ...
    async def get_public_announcements(self, company_id: int, page: int = 1,
                                       per_page: int = 10) -> AnnouncementListResponse:
    ...
    async def upload_announcement_image(self, user: User, announcement_id: int,
                                        file: UploadFile) -> AnnouncementResponse:
