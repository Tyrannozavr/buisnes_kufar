...
class Message(Base):
    ...
    # Relationships
    from_company: Mapped["Company"] = relationship("Company", foreign_keys=[from_company_id], back_populates="sent_messages")
    to_company: Mapped["Company"] = relationship("Company", foreign_keys=[to_company_id], back_populates="received_messages") 