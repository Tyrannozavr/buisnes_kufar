...
async def complete_employee_registration():
    """Завершаем регистрацию сотрудника через API"""
    
    # Данные для завершения регистрации
    token = "P5GsDZMDJV8t1yzK_Du19bb57yw0G_mikG3TtFVBcNo"
    ...
    try:
        ...
        if response.status_code == 200:
            print("✅ Регистрация сотрудника завершена успешно!")
            data = response.json()
...
if __name__ == "__main__":
    asyncio.run(complete_employee_registration())
