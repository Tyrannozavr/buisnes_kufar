#!/usr/bin/env python3
"""Create or update a local admin user. Usage: poetry run python scripts/ensure_local_admin.py"""
import asyncio
import os
import random
import sys
...
ADMIN_EMAIL = os.environ.get("ADMIN_EMAIL", "dmitiry40647274@gmail.com")
ADMIN_PASSWORD = os.environ.get("ADMIN_PASSWORD", "123456")
ADMIN_PHONE = os.environ.get("ADMIN_PHONE", "79000000406")
COMPANY_NAME = os.environ.get("ADMIN_COMPANY_NAME", "Компания администратора (локально)")
...
async def main() -> None:
    async with AsyncSessionLocal() as session:
        ...
        slug = await _unique_slug(session, "local-admin-company")
