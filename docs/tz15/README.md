...
| **7** | 20k | Данные заполнения (адреса) · вес товара · «Заполнить данными» без проверок | ▶️ **текущий** [etap-07](etap-07-company-fill-product.md) |
| **8** | 20k | Таблица «Продажи» по ТЗ_15 · диалоги «Создать документ» · перевозка MVP | ⏳ [etap-08](etap-08-sales-table-dialogs.md) |

**Следующий шаг:** реализовать [этап 7](etap-07-company-fill-product.md). Оригинал ТЗ: [ТЗ_Изменения.docx](./ТЗ_Изменения.docx).
